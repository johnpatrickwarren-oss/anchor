...
The command handlers are dependency-injected (adapter, persistence, clock, stdout, model-list) and unit-tested offline (29 tests); the wired stack is validated end-to-end via `--mock`.
