...
import {
  ...
  ROUTING_PROVENANCE, checkModelDrift, decompose, runProject, planStages, renderStages,
} from '@anchor/core';
...
// Build per-feature EngineDeps for a project stage's wave (mirrors cmdWave's depsFor: advisory
// structural gates, a green-test gate scoped to the feature's worktree, the shared memorial).
function featureCycleDeps(
