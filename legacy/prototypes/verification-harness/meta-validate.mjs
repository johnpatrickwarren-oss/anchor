...
const TARGET = '/tmp/anchor-ctxbench/dyn-arm';        // known-good validator (the thing we mutate)
const GRADE = '/tmp/anchor-ctxbench/grade.mjs';       // the ORACLE (1299-case spec suite)
